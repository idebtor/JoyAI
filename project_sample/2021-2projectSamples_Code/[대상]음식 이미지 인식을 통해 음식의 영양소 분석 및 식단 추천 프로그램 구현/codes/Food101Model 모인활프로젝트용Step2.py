...
n_classes = 6 # 6 types of food
img_width, img_height = 299, 299
train_data_dir = 'food-101/train'
validation_data_dir = 'food-101/test'
nb_train_samples = 4500 # train set for 6 types of food
nb_validation_samples = 1500 # test set for  6 types of food
batch_size = 20
...
predictions = Dense(6,kernel_regularizer=regularizers.l2(0.005), activation='softmax')(x) # predictions within 6 types
